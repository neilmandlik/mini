                ...
                <>
                    ...
                    {isInRange?
                        <>
                            ...
                            <button className="reduceMargin" onClick={handleGetRange}>Enter</button> &nbsp; &nbsp;
                            <button className="reduceMargin" onClick={handleClickRange}>See Feedback Report for a {isInRange?"Particular Semester":"Range of Semesters"}</button> <br /> <br />
                    ...
                    :
                        <>
                            ...
                            <button className="reduceMargin" onClick={()=>handleDataClear(0)}>Clear All</button> &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <button className="reduceMargin" onClick={()=>handleDataClear(1)}>Generate Total Report</button>
                            <br /> <br />
