...
function SPracticalTable({tableData}){
    ...
    const columns=useMemo(()=>[
        ...
        
        {
            ...
            columns:[
                {
                    Header:"Deadline Date",
                    accessor:`A4.deadline_date`,
                },
                {
                    Header:"Submission Date",
                    accessor:"A4.submission_date",
                },
                {
                    Header: "Marks Allocated",
                    accessor:"A4.marks_given",
                }
            ]
        },
        
        {
            ...
            columns:[
                {
                    Header:"Deadline Date",
                    accessor:`A5.deadline_date`,
                },
                {
                    Header:"Submission Date",
                    accessor:"A5.submission_date",
                },
                {
                    Header: "Marks Allocated",
                    accessor:"A5.marks_given",
                }
            ]
        },
    ],[])
...
export default SPracticalTable